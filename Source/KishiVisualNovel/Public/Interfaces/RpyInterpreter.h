...
public:
  ...
  virtual bool Show_Implementation(const UPaperSprite *image, FName at,
                                   FName with) = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  bool Hide(FName name, const TMap<FName, FString> &params);
  virtual bool Hide_Implementation(FName name,
                                   const TMap<FName, FString> &params) = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  bool PlayMusic(FName name, const TMap<FName, FString> &params);
  virtual bool PlayMusic_Implementation(FName name,
                                        const TMap<FName, FString> &params) = 0;
  ...
  virtual bool Menu_Implementation(const FString &statement,
                                   const TArray<FString> &choices) = 0;

  // variables
  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeBool() const;
  virtual TArray<FName> GetVariablesOfTypeBool_Implementation() const = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeInt() const;
  virtual TArray<FName> GetVariablesOfTypeInt_Implementation() const = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeFloat() const;
  virtual TArray<FName> GetVariablesOfTypeFloat_Implementation() const = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeName() const;
  virtual TArray<FName> GetVariablesOfTypeName_Implementation() const = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeString() const;
  virtual TArray<FName> GetVariablesOfTypeString_Implementation() const = 0;

  UFUNCTION(BlueprintCallable, BlueprintNativeEvent)
  TArray<FName> GetVariablesOfTypeVector() const;
  virtual TArray<FName> GetVariablesOfTypeVector_Implementation() const = 0;
