...
class KISHIVISUALNOVEL_API UDynamicTree : public UBaseTree
{
    GENERATED_BODY()
};

class KISHIVISUALNOVEL_API IDynamicTree : public IBaseTree
{
    GENERATED_BODY()
public:
...
UCLASS()
class KISHIVISUALNOVEL_API UDynamicTreeLibrary : public UBaseTreeLibrary
{
    GENERATED_BODY()
public:
    /*
