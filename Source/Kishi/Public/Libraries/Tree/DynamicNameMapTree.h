...
class KISHI_API UDynamicNameMapTree : public UNameMapTree
{
    GENERATED_BODY()
};

class KISHI_API IDynamicNameMapTree : public INameMapTree
{
    GENERATED_BODY()
public:
...
UCLASS()
class KISHI_API UDynamicNameMapTreeLibrary : public UNameMapTreeLibrary
{
    GENERATED_BODY()
public:
    /*
