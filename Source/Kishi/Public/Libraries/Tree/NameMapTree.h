...
class KISHI_API UNameMapTree : public UArrayTree
{
    GENERATED_BODY()
};

class KISHI_API INameMapTree : public IArrayTree
{
    GENERATED_BODY()
public:
...
UCLASS()
class KISHI_API UNameMapTreeLibrary : public UArrayTreeLibrary
{
    GENERATED_BODY()
public:
    /*
