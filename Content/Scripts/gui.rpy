...
define gui.hover_color = '#fb3ebe'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#c03865'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#c03865'
...
define gui.name_text_font = "Postamt.ttf"
...
define gui.namebox_height = 44

## The borders of the box containing the character's name, in left, top, right,
## bottom order.
define gui.namebox_borders = Borders(30, 12, 20, 5)
...
define gui.choice_button_text_insensitive_color = "#aaa"
...
define gui.main_menu_text_xalign = 10
